\subsection{Odporúčací systém}                                                                                                                                                                                                   
  ...
  Pre aplikáciu Joinly sme zvolili \textbf{Weighted Hybrid System} —
  ...
  Príklady normalizovaných hodnôt:
  \begin{itemize}
  ...
  Výsledkom výpočtu je zoznam objektov \texttt{ScoredEvent} zoradený
  zostupne podľa skóre. Odporúčania sa zobrazujú na obrazovke
  \texttt{RecommendedEventsScreen}, kde každý event zobrazuje aj
