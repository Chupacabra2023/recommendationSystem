...
\subsubsection{Technológia QR kódov a ich štruktúra}
QR kód (\textit{Quick Response Code}) predstavuje dvojrozmerný (2D) čiarový kód, ktorý bol navrhnutý pre vysokorýchlostné čítanie a veľkú kapacitu dát v porovnaní s tradičnými 1D kódmi. Podľa \cite{7966807} je jeho štruktúra definovaná niekoľkými kľúčovými prvkami, ktoré umožňujú spoľahlivú detekciu aj pri čiastočnom poškodení alebo zlej kvalite obrazu:
...
V kontexte mobilnej aplikácie slúži táto technológia ako efektívny nástroj na automatizáciu interakcie, napríklad pri procese registrácie účastníka na podujatie (Check-in), kde nahrádza manuálne zadávanie údajov.
%(Zdroj: \url{https://ieeexplore.ieee.org/abstract/document/7966807}
  \iffalse
