...
\begin{itemize}
    ...
    \item odporúčací systém,
    \item možnosť hodnotenia udalostí,
    \item možnosť odísť z udalosti.
    \item moznost upravit profil (avatar, meno, popis)
%    \item  Check-in systém (QR kód + manuálny) — nie je v požiadavkách vôbec
%    \item  Deadline odhlásenia (cancelDeadlineHours) — súčasť penalizácie ale detailnejšie ako požiadavky
%    \item  Súkromné eventy s heslom — nie je explicitne v zozname
%    \item  Pozvánky (Invitation systém — pozvanie konkrétneho usera emailom) — nie je v zozname
%    \item  Poradovník je v zozname, ale auto-promote (automatické povýšenie z waitlistu pri odchode) je navyše
%    \item  Zákaz konkrétneho usera z eventu (bannedUsers na evente) — zoznam má len "odstrániť účastníka", nie permanentný ban z eventu
%    \item  Prijatie/odmietnutie pozvánky
%    \item  Auto-povýšenie z poradovníka
%    \item  Auto-ban za 3 nahlásenia
%    \item  Plánovanie alarmu pre notifikáciu

%
https://creately.com/diagram/example/gm75skpc1/navigation-diagram
...
\begin{enumerate}
    ...
    \item vymazanie associácie medzi userom a eventom po zablokovaní usera alebo zmazaní eventu
    \item Automatické skrytie udalostí na mape po datume konania
\end{enumerate}
